...
const navItems = [
  ...
  { type: 'link', label: 'E-Books', to: '/about', className: 'lg:!ml-4', isDropdown: false },
  {
    type: 'dropdown',
    ...
    dropdownContent: [
      ...
      },
      {
        ...
        subItems: [
          { label: 'Entrepreneurship & Business Skills', href: 'product-bottom-thumbnail.html' },
          { label: 'Job Market & Employment', href: '/' },
          { label: 'Professional & Vocational Training', href: '/' },
          {
            label: 'Technology & Automation in Careers',
            href: 'product-left-thumbnail.html',
            hot: true,
          },
          { label: 'Workplace & Corporate Growth', href: 'product-right-thumbnail.html' },
        ],
      },
    ],
  },
  {
    type: 'link',
    label: 'Pre-Loved Books',
    to: '/contact',
    className: 'dropdown new-nav-item lg:!ml-6',
    isDropdown: false,
  },
